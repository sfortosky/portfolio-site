        ...
        <section id="home" className="min-h-screen flex flex-col justify-center items-center px-6 pt-16 bg-white dark:bg-slate-950 transition-colors duration-300">
            <div className="text-center max-w-4xl">
                ...
                <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
                    Teacher pivoting to a career in software development
                </p>
            ...
            <Link to="about" smooth={true} duration={500} offset={-70}>
                <div className="absolute bottom-10 animate-bounce text-slate-300 dark:text-slate-700 cursor-pointer">
                    <ChevronDown size={32} />
                </div>
            </Link>
        </section>
